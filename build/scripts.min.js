...
return this._addScales(n,e,i),t.on(n.updateWhenIdle?"moveend":"move",this._update,this),t.whenReady(this._update,this),i},onRemove:function(t){t.off(this.options.updateWhenIdle?"moveend":"move",this._update,this)},_addScales:function(t,e,i){t.metric&&(this._mScale=o.DomUtil.create("div",e+"-line",i)),t.imperial&&(this._iScale=o.DomUtil.create("div",e+"-line",i))},_update:function(){var t=this._map.getBounds(),e=t.getCenter().lat,i=6378137*Math.PI*Math.cos(e*Math.PI/180),n=i*(t.getNorthEast().lng-t.getSouthWest().lng)/180,o=this._map.getSize(),s=this.options,a=0;o.x>0&&(a=n*(s.maxWidth/o.x)),this._updateScales(s,a)},_updateScales:function(t,e){t.metric&&e&&this._updateMetric(e),t.imperial&&e&&this._updateImperial(e)},_updateMetric:function(t){var e=this._getRoundNum(t);this._mScale.style.width=this._getScaleWidth(e/t)+"px",this._mScale.innerHTML=1e3>e?e+" m":e/1e3+" km"},_updateImperial:function(t){var e,i,n,o=3.2808399*t,s=this._iScale;o>5280?(e=o/5280,i=this._getRoundNum(e),s.style.width=this._getScaleWidth(i/e)+"px",s.innerHTML=i+" mi"):(n=this._getRoundNum(o),s.style.width=this._getScaleWidth(n/o)+"px",s.innerHTML=n+" ft")},_getScaleWidth:function(t){return Math.round(this.options.maxWidth*t)-10},_getRoundNum:function(t){var e=Math.pow(10,(Math.floor(t)+"").length-1),i=t/e;return i=i>=10?10:i>=5?5:i>=3?3:i>=2?2:1,e*i}}),o.control.scale=function(t){return new o.Control.Scale(t)},o.Control.Layers=o.Control.extend({options:{collapsed:!0,position:"topright",autoZIndex:!0},initialize:function(t,e,i){o.setOptions(this,i),this._layers={},this._lastZIndex=0,this._handlingClick=!1;for(var n in t)this._addLayer(t[n],n);for(n in e)this._addLayer(e[n],n,!0)},onAdd:function(t){return this._initLayout(),this._update(),t.on("layeradd",this._onLayerChange,this).on("layerremove",this._onLayerChange,this),this._container},onRemove:function(t){t.off("layeradd",this._onLayerChange,this).off("layerremove",this._onLayerChange,this)},addBaseLayer:function(t,e){return this._addLayer(t,e),this._update(),this},addOverlay:function(t,e){return this._addLayer(t,e,!0),this._update(),this},removeLayer:function(t){var e=o.stamp(t);return delete this._layers[e],this._update(),this},_initLayout:function(){var t="leaflet-control-layers",e=this._container=o.DomUtil.create("div",t);e.setAttribute("aria-haspopup",!0),o.Browser.touch?o.DomEvent.on(e,"click",o.DomEvent.stopPropagation):o.DomEvent.disableClickPropagation(e).disableScrollPropagation(e);var i=this._form=o.DomUtil.create("form",t+"-list");if(this.options.collapsed){o.Browser.android||o.DomEvent.on(e,"mouseover",this._expand,this).on(e,"mouseout",this._collapse,this);var n=this._layersLink=o.DomUtil.create("a",t+"-toggle",e);n.href="#",n.title="Layers",o.Browser.touch?o.DomEvent.on(n,"click",o.DomEvent.stop).on(n,"click",this._expand,this):o.DomEvent.on(n,"focus",this._expand,this),o.DomEvent.on(i,"click",function(){setTimeout(o.bind(this._onInputClick,this),0)},this),this._map.on("click",this._collapse,this)}else this._expand();this._baseLayersList=o.DomUtil.create("div",t+"-base",i),this._separator=o.DomUtil.create("div",t+"-separator",i),this._overlaysList=o.DomUtil.create("div",t+"-overlays",i),e.appendChild(i)},_addLayer:function(t,e,i){var n=o.stamp(t);this._layers[n]={layer:t,name:e,overlay:i},this.options.autoZIndex&&t.setZIndex&&(this._lastZIndex++,t.setZIndex(this._lastZIndex))},_update:function(){if(this._container){this._baseLayersList.innerHTML="",this._overlaysList.innerHTML="";var t,e,i=!1,n=!1;for(t in this._layers)e=this._layers[t],this._addItem(e),n=n||e.overlay,i=i||!e.overlay;this._separator.style.display=n&&i?"":"none"}},_onLayerChange:function(t){var e=this._layers[o.stamp(t.layer)];if(e){this._handlingClick||this._update();var i=e.overlay?"layeradd"===t.type?"overlayadd":"overlayremove":"layeradd"===t.type?"baselayerchange":null;i&&this._map.fire(i,e)}},_createRadioElement:function(t,i){var n='<input type="radio" class="leaflet-control-layers-selector" name="'+t+'"';i&&(n+=' checked="checked"'),n+="/>";var o=e.createElement("div");return o.innerHTML=n,o.firstChild},_addItem:function(t){var i,n=e.createElement("label"),s=this._map.hasLayer(t.layer);t.overlay?(i=e.createElement("input"),i.type="checkbox",i.className="leaflet-control-layers-selector",i.defaultChecked=s):i=this._createRadioElement("leaflet-base-layers",s),i.layerId=o.stamp(t.layer),o.DomEvent.on(i,"click",this._onInputClick,this);var a=e.createElement("span");a.innerHTML=" "+t.name,n.appendChild(i),n.appendChild(a);var r=t.overlay?this._overlaysList:this._baseLayersList;return r.appendChild(n),n},_onInputClick:function(){var t,e,i,n=this._form.getElementsByTagName("input"),o=n.length;for(this._handlingClick=!0,t=0;o>t;t++)e=n[t],i=this._layers[e.layerId],e.checked&&!this._map.hasLayer(i.layer)?this._map.addLayer(i.layer):!e.checked&&this._map.hasLayer(i.layer)&&this._map.removeLayer(i.layer);this._handlingClick=!1,this._refocusOnMap()},_expand:function(){o.DomUtil.addClass(this._container,"leaflet-control-layers-expanded")},_collapse:function(){this._container.className=this._container.className.replace(" leaflet-control-layers-expanded","")}}),o.control.layers=function(t,e,i){return new o.Control.Layers(t,e,i)},o.PosAnimation=o.Class.extend({includes:o.Mixin.Events,run:function(t,e,i,n){this.stop(),this._el=t,this._inProgress=!0,this._newPos=e,this.fire("start"),t.style[o.DomUtil.TRANSITION]="all "+(i||.25)+"s cubic-bezier(0,0,"+(n||.5)+",1)",o.DomEvent.on(t,o.DomUtil.TRANSITION_END,this._onTransitionEnd,this),o.DomUtil.setPosition(t,e),o.Util.falseFn(t.offsetWidth),this._stepTimer=setInterval(o.bind(this._onStep,this),50)},stop:function(){this._inProgress&&(o.DomUtil.setPosition(this._el,this._getPos()),this._onTransitionEnd(),o.Util.falseFn(this._el.offsetWidth))},_onStep:function(){var t=this._getPos();return t?(this._el._leaflet_pos=t,void this.fire("step")):void this._onTransitionEnd()},_transformRe:/([-+]?(?:\d*\.)?\d+)\D*, ([-+]?(?:\d*\.)?\d+)\D*\)/,_getPos:function(){var e,i,n,s=this._el,a=t.getComputedStyle(s);if(o.Browser.any3d){if(n=a[o.DomUtil.TRANSFORM].match(this._transformRe),!n)return;e=parseFloat(n[1]),i=parseFloat(n[2])}else e=parseFloat(a.left),i=parseFloat(a.top);return new o.Point(e,i,!0)},_onTransitionEnd:function(){o.DomEvent.off(this._el,o.DomUtil.TRANSITION_END,this._onTransitionEnd,this),this._inProgress&&(this._inProgress=!1,this._el.style[o.DomUtil.TRANSITION]="",this._el._leaflet_pos=this._newPos,clearInterval(this._stepTimer),this.fire("step").fire("end"))}}),o.Map.include({setView:function(t,e,n){if(e=e===i?this._zoom:this._limitZoom(e),t=this._limitCenter(o.latLng(t),e,this.options.maxBounds),n=n||{},this._panAnim&&this._panAnim.stop(),this._loaded&&!n.reset&&n!==!0){n.animate!==i&&(n.zoom=o.extend({animate:n.animate},n.zoom),n.pan=o.extend({animate:n.animate},n.pan));var s=this._zoom!==e?this._tryAnimatedZoom&&this._tryAnimatedZoom(t,e,n.zoom):this._tryAnimatedPan(t,n.pan);if(s)return clearTimeout(this._sizeTimer),this}return this._resetView(t,e),this},panBy:function(t,e){if(t=o.point(t).round(),e=e||{},!t.x&&!t.y)return this;if(this._panAnim||(this._panAnim=new o.PosAnimation,this._panAnim.on({step:this._onPanTransitionStep,end:this._onPanTransitionEnd},this)),e.noMoveStart||this.fire("movestart"),e.animate!==!1){o.DomUtil.addClass(this._mapPane,"leaflet-pan-anim");var i=this._getMapPanePos().subtract(t);this._panAnim.run(this._mapPane,i,e.duration||.25,e.easeLinearity)}else this._rawPanBy(t),this.fire("move").fire("moveend");return this},_onPanTransitionStep:function(){this.fire("move")},_onPanTransitionEnd:function(){o.DomUtil.removeClass(this._mapPane,"leaflet-pan-anim"),this.fire("moveend")},_tryAnimatedPan:function(t,e){var i=this._getCenterOffset(t)._floor();return(e&&e.animate)===!0||this.getSize().contains(i)?(this.panBy(i,e),!0):!1}}),o.PosAnimation=o.DomUtil.TRANSITION?o.PosAnimation:o.PosAnimation.extend({run:function(t,e,i,n){this.stop(),this._el=t,this._inProgress=!0,this._duration=i||.25,this._easeOutPower=1/Math.max(n||.5,.2),this._startPos=o.DomUtil.getPosition(t),this._offset=e.subtract(this._startPos),this._startTime=+new Date,this.fire("start"),this._animate()},stop:function(){this._inProgress&&(this._step(),this._complete())},_animate:function(){this._animId=o.Util.requestAnimFrame(this._animate,this),this._step()},_step:function(){var t=+new Date-this._startTime,e=1e3*this._duration;e>t?this._runFrame(this._easeOut(t/e)):(this._runFrame(1),this._complete())},_runFrame:function(t){var e=this._startPos.add(this._offset.multiplyBy(t));o.DomUtil.setPosition(this._el,e),this.fire("step")},_complete:function(){o.Util.cancelAnimFrame(this._animId),this._inProgress=!1,this.fire("end")},_easeOut:function(t){return 1-Math.pow(1-t,this._easeOutPower)}}),o.Map.mergeOptions({zoomAnimation:!0,zoomAnimationThreshold:4}),o.DomUtil.TRANSITION&&o.Map.addInitHook(function(){this._zoomAnimated=this.options.zoomAnimation&&o.DomUtil.TRANSITION&&o.Browser.any3d&&!o.Browser.android23&&!o.Browser.mobileOpera,this._zoomAnimated&&o.DomEvent.on(this._mapPane,o.DomUtil.TRANSITION_END,this._catchTransitionEnd,this)}),o.Map.include(o.DomUtil.TRANSITION?{_catchTransitionEnd:function(t){this._animatingZoom&&t.propertyName.indexOf("transform")>=0&&this._onZoomTransitionEnd()},_nothingToAnimate:function(){return!this._container.getElementsByClassName("leaflet-zoom-animated").length},_tryAnimatedZoom:function(t,e,i){if(this._animatingZoom)return!0;if(i=i||{},!this._zoomAnimated||i.animate===!1||this._nothingToAnimate()||Math.abs(e-this._zoom)>this.options.zoomAnimationThreshold)return!1;var n=this.getZoomScale(e),o=this._getCenterOffset(t)._divideBy(1-1/n),s=this._getCenterLayerPoint()._add(o);return i.animate===!0||this.getSize().contains(o)?(this.fire("movestart").fire("zoomstart"),this._animateZoom(t,e,s,n,null,!0),!0):!1},_animateZoom:function(t,e,i,n,s,a,r){r||(this._animatingZoom=!0),o.DomUtil.addClass(this._mapPane,"leaflet-zoom-anim"),this._animateToCenter=t,this._animateToZoom=e,o.Draggable&&(o.Draggable._disabled=!0),o.Util.requestAnimFrame(function(){this.fire("zoomanim",{center:t,zoom:e,origin:i,scale:n,delta:s,backwards:a})},this)},_onZoomTransitionEnd:function(){this._animatingZoom=!1,o.DomUtil.removeClass(this._mapPane,"leaflet-zoom-anim"),this._resetView(this._animateToCenter,this._animateToZoom,!0,!0),o.Draggable&&(o.Draggable._disabled=!1)}}:{}),o.TileLayer.include({_animateZoom:function(t){this._animating||(this._animating=!0,this._prepareBgBuffer());var e=this._bgBuffer,i=o.DomUtil.TRANSFORM,n=t.delta?o.DomUtil.getTranslateString(t.delta):e.style[i],s=o.DomUtil.getScaleString(t.scale,t.origin);e.style[i]=t.backwards?s+" "+n:n+" "+s},_endZoomAnim:function(){var t=this._tileContainer,e=this._bgBuffer;t.style.visibility="",t.parentNode.appendChild(t),o.Util.falseFn(e.offsetWidth),this._animating=!1},_clearBgBuffer:function(){var t=this._map;!t||t._animatingZoom||t.touchZoom._zooming||(this._bgBuffer.innerHTML="",this._bgBuffer.style[o.DomUtil.TRANSFORM]="")},_prepareBgBuffer:function(){var t=this._tileContainer,e=this._bgBuffer,i=this._getLoadedTilesPercentage(e),n=this._getLoadedTilesPercentage(t);return e&&i>.5&&.5>n?(t.style.visibility="hidden",void this._stopLoadingImages(t)):(e.style.visibility="hidden",e.style[o.DomUtil.TRANSFORM]="",this._tileContainer=e,e=this._bgBuffer=t,this._stopLoadingImages(e),void clearTimeout(this._clearBgBufferTimer))},_getLoadedTilesPercentage:function(t){var e,i,n=t.getElementsByTagName("img"),o=0;for(e=0,i=n.length;i>e;e++)n[e].complete&&o++;return o/i},_stopLoadingImages:function(t){var e,i,n,s=Array.prototype.slice.call(t.getElementsByTagName("img"));for(e=0,i=s.length;i>e;e++)n=s[e],n.complete||(n.onload=o.Util.falseFn,n.onerror=o.Util.falseFn,n.src=o.Util.emptyImageUrl,n.parentNode.removeChild(n))}}),o.Map.include({_defaultLocateOptions:{watch:!1,setView:!1,maxZoom:1/0,timeout:1e4,maximumAge:0,enableHighAccuracy:!1},locate:function(t){if(t=this._locateOptions=o.extend(this._defaultLocateOptions,t),!navigator.geolocation)return this._handleGeolocationError({code:0,message:"Geolocation not supported."}),this;var e=o.bind(this._handleGeolocationResponse,this),i=o.bind(this._handleGeolocationError,this);return t.watch?this._locationWatchId=navigator.geolocation.watchPosition(e,i,t):navigator.geolocation.getCurrentPosition(e,i,t),this},stopLocate:function(){return navigator.geolocation&&navigator.geolocation.clearWatch(this._locationWatchId),this._locateOptions&&(this._locateOptions.setView=!1),this},_handleGeolocationError:function(t){var e=t.code,i=t.message||(1===e?"permission denied":2===e?"position unavailable":"timeout");this._locateOptions.setView&&!this._loaded&&this.fitWorld(),this.fire("locationerror",{code:e,message:"Geolocation error: "+i+"."})},_handleGeolocationResponse:function(t){var e=t.coords.latitude,i=t.coords.longitude,n=new o.LatLng(e,i),s=180*t.coords.accuracy/40075017,a=s/Math.cos(o.LatLng.DEG_TO_RAD*e),r=o.latLngBounds([e-s,i-a],[e+s,i+a]),h=this._locateOptions;if(h.setView){var l=Math.min(this.getBoundsZoom(r),h.maxZoom);this.setView(n,l)}var u={latlng:n,bounds:r,timestamp:t.timestamp};for(var c in t.coords)"number"==typeof t.coords[c]&&(u[c]=t.coords[c]);this.fire("locationfound",u)}})}(window,document);var appm=angular.module("appm",["ngRoute","navControllers","ngAnimate"]).directive("kkk",function(){return function($scope,element){}}).run(function($rootScope){$rootScope.changeLang=function(){},$rootScope.orbit});appm.config(["$routeProvider",function($routeProvider){$routeProvider.when("/home",{templateUrl:"module/home/home.html",controller:"home"}).when("/about",{templateUrl:"module/about/about.html",controller:"about"}).when("/web",{templateUrl:"module/web/web.html",controller:"web"}).when("/web/:type",{templateUrl:"module/web/web.html",controller:"web"}).when("/design",{templateUrl:"module/design/design.html",controller:"design"}).when("/contact",{templateUrl:"module/contact/contact.html",controller:"contact"}).when("/print",{templateUrl:"module/contact/contact.html",controller:"print"}).otherwise({redirectTo:"/home"})}]);var navControllers=angular.module("navControllers",[]).directive("orbit",function($http,$rootScope){return function($scope,element,attrs){$rootScope.orbit?($(element).orbit(),$(element).css({opacity:1})):$http.get("lib/jQuery/jquery.orbit-1.3.0.js").success(function(data){$rootScope.orbit=data,eval(data),$(element).orbit(),$(element).css({opacity:1})})}}).directive("jscroll",function(){return function($scope,element){$(element).scrollNav({headlineText:"",topLinkText:"",fixedMargin:140,scrollOffset:50})}}).directive("transport",function(){return function(){function showThumbnail(href,title){largeImg.src=href,largeImg.alt=title}var largeImg=document.getElementById("largeImg"),thumbs=document.getElementById("thumbs");thumbs.onclick=function(e){e=e||window.event;for(var target=e.target||e.srcElement;target!=this;){if("A"==target.nodeName)return showThumbnail(target.href,target.title),!1;target=target.parentNode}};for(var imgs=thumbs.getElementsByTagName("img"),i=0;i<imgs.length;i++){var url=imgs[i].parentNode.href,img=document.createElement("img");img.src=url}}});navControllers.run(function($rootScope){$rootScope.orbit=null,$rootScope.jscroll=null}),navControllers.directive("navsElements",function(showService){return{restrict:"A",link:function(scope,el){showService.el.push(el)}}}),navControllers.service("showService",function(){var s=this;this.el=[],this.activeString=null,this.active=function(string){for(var i=0;i<s.el.length;i++)s.el[i].attr("href")==string?(s.el[i].addClass("active"),s.activeString=string):s.el[i].removeClass("active")}});var el;appm.controller("nav",function($scope,$http,$location,showService,$rootScope){function lang(l){$http.get("lang/"+l+".json").success(function(data){$scope.navs=data;for(var i=0;i<$scope.navs.length;i++)$scope.navs[i].href==showService.activeString&&($scope.navs[i].active="active")})}function langPpd(l){$http.get("lang/ppd."+l+".json").success(function(data){$scope.langPpd=data})}$scope.lang="en",lang("en"),langPpd("en"),$scope.download="Download",$scope.olo="Lipatov_en.pdf",$scope.chLang=function(p){switch(showService.el=[],p){case"ru":$scope.olo="Lipatov_en.pdf",$scope.download="Download";break;default:$scope.olo="Lipatov_ru.pdf",$scope.download="Скачать"}lang($scope.lang),langPpd($scope.lang),$rootScope.changeLang()},$scope.getLocation=function(){return $location.path()},$scope.path=function(d){$location.path(d)}}),navControllers.controller("home",function($scope,$http,$routeParams,$rootScope,showService,factSkill){function getContent(){$scope.content="module/home/home_"+$scope.lang+".html",$scope.includeHtml="module/home/skills_"+$scope.lang+".html"}showService.active("#/home"),factSkill.getSk($scope),getContent(),$rootScope.changeLang=function(){getContent()}}),navControllers.controller("about",function($scope,$http,$routeParams,$rootScope,showService){function getContent(){$http.get("module/about/"+$scope.lang+".json").success(function(data){$scope.text=data}),$scope.content="module/about/about_"+$scope.lang+".html"}getContent(),showService.active("#/about"),$rootScope.changeLang=function(){getContent()}}),navControllers.controller("web",function($scope,$http,$routeParams,$rootScope,showService){function getContent(){$http.get("module/web/"+$scope.lang+".json").success(function(data){$scope.text=data}),$scope.content=$routeParams.type?"module/web/"+$routeParams.type+"/"+$routeParams.type+"_"+$scope.lang+".html":"module/web/web_"+$scope.lang+".html"}getContent(),$scope.pp="block",showService.active("#/web"),$rootScope.changeLang=function(){getContent()}}),navControllers.controller("design",function($scope,$http,$routeParams,$rootScope,showService){function getContent(){$http.get("module/design/"+$scope.lang+".json").success(function(data){$scope.text=data}),$scope.content="module/design/design_"+$scope.lang+".html"}getContent(),showService.active("#/design"),$rootScope.changeLang=function(){getContent()}}),navControllers.controller("print",function($scope,$http,$routeParams,$rootScope,showService,factSkill){function getContent(){$http.get("module/print/"+$scope.lang+".json").success(function(data){$scope.text=data}),$scope.content="module/print/print_"+$scope.lang+".html",$scope.includeHtml="module/home/skills_"+$scope.lang+".html",$scope.experienceUrl="module/about/about_"+$scope.lang+".html",factSkill.getSk($scope)}getContent(),showService.active("#/print"),$rootScope.changeLang=function(){getContent()}}),navControllers.controller("contact",function($scope,$http,$routeParams,$rootScope,showService){function getContent(){$http.get("module/contact/"+$scope.lang+".json").success(function(data){$scope.text=data}),$scope.content="module/contact/contact_"+$scope.lang+".html"}$scope.mapUrl="module/contact/map.html",getContent(),showService.active("#/contact"),$rootScope.changeLang=function(){getContent()}}),navControllers.directive("leafletMap",function(){return{restrict:"A",controller:function($scope){$scope.map=L.map("map").setView([50.4,30.48],11),console.log("a"),L.tileLayer("https://{s}.tiles.mapbox.com/v3/{id}/{z}/{x}/{y}.png",{maxZoom:18,id:"examples.map-i875mjb7"}).addTo($scope.map),L.circle([50.39,30.49],2e3,{color:"transparent",fillColor:"#f03",fillOpacity:.2}).addTo($scope.map).bindPopup("lmaxim@mail.ru")},link:function(){console.log("b")}}}),navControllers.directive("blockSkill",function(factSkill){return{restrict:"A",templateUrl:"partial/skillGraph.html",link:function(scope){factSkill.getSk(scope)}}}),navControllers.directive("start",function(){return{restrict:"A",link:function(scope,el,attr){attr.$observe("start",function(value){el.css({left:value+"%"})}),attr.$observe("width",function(value){el.css({width:value+"%"})})}}}),navControllers.directive("notUse",function(){return{restrict:"A",link:function(scope,el,attr){attr.$observe("notUse",function(value){el.css(100==value?{visibility:"hidden"}:{left:value+"%"})})}}}),navControllers.controller("graph",function($scope,vhide){$scope.v={},$scope.v=vhide.v,$scope.click=function(){$scope.v.show=$scope.v.show?"":"show"}}),navControllers.service("vhide",function(){this.v={show:"show"}}),navControllers.factory("factSkill",function($http){function formatData(arr){for(var i=0;i<arr.length;i++)arr[i].valueStart=setStartDate(arr[i].start||0),arr[i].valueWidth=setWidth(arr[i].start||0,arr[i].end||0),arr[i].valueNotUse=setNotUse(arr[i].end||0),arr[i].dateStart=getDate(arr[i].start),arr[i].dateEnd=getDate(arr[i].end)}function getDate(string){var date=null,f=parseFloat;if(string){var parms=string.split("."),yy=f(parms[0]),MM=f(parms[1]-1),dd=f(parms[2]);date=new Date(yy,MM,dd).getTime()}return date}function setNotUse(string){return string?setStartDate(string):100}function setWidth(stringStart,stringEnd){if(stringStart&&stringEnd)return setStartDate(stringEnd)-setStartDate(stringStart);var start=stringStart?setStartDate(stringStart):0,_end=stringEnd?setStartDate(stringEnd):100;return _end-start}function setStartDate(string){var date,initDate=new Date(2013,0,1),currrentDate=new Date,parms=string.split("."),f=parseFloat;if(string){var yy=f(parms[0]),MM=f(parms[1]-1),dd=f(parms[2]);date=new Date(yy,MM,dd)}else date=initDate;var valueStart=date.getTime()-initDate.getTime(),allDate=currrentDate.getTime()-initDate.getTime();return valueStart=100*valueStart/allDate,valueStart=Math.ceil(valueStart)}function getSk(scope){$http.get("lang/skill.json").success(function(d){formatData(d),scope.skills=d})}return{getSk:getSk}});
